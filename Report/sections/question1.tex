...
only two possible outcomes (we are not predicting a continuous value which regression is used for).
...
\begin{table}[h]
    ...
    \begin{tabular}{cc}
        \hline
        \textbf{Churn} & \textbf{Mean (in Rands)} \\
        \hline
...
any positive cases (churns). These positive cases are the customers the company actually wants to identify so that
